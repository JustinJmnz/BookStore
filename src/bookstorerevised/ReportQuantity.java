 ...
 * @author Justin
 */
public class ReportQuantity extends JFrame implements ActionListener {
    ...
    public ReportQuantity(String title) throws FileNotFoundException{
        super(title);
        setSize(600,500);
        ...
        btnBack = new JButton("Back");
            ...
            panel.add(btnBack, c);
       lblInfo = new JLabel("Listed by Quantity (Least to Greatest)");
            c.gridx = 0;
            c.gridy = 1;
            panel.add(lblInfo, c);
    ...
    public void sort(){
     Collections.sort(books, new Comparator<BookInfo>(){
            ...
            public int compare(BookInfo book1, BookInfo book2) {
                Integer b1 = book1.getQuantity();
                Integer b2 = book2.getQuantity();
        ...
        for(int a = 0; a < FileRead.books.size(); a++){
            ...
            output += "\n";
            quantityAmount += FileRead.books.get(a).getQuantity();
        }
        output += ("Total amount of books: " + quantityAmount);
    }
