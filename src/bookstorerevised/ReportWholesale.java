 ...
 * @author Justin
 */
public class ReportWholesale extends JFrame implements ActionListener {
    ...
    public ReportWholesale(String title) throws FileNotFoundException{
        super(title);
        setSize(600,500);
        ...
        btnBack = new JButton("Back");
            ...
            panel.add(btnBack, c);
       lblInfo = new JLabel("Listed by Wholesale Value (Least to Greatest)");
            c.gridx = 0;
            c.gridy = 1;
            panel.add(lblInfo, c);
    ...
    public void sort(){
     Collections.sort(books, new Comparator<BookInfo>(){
            ...
            public int compare(BookInfo book1, BookInfo book2) {
                Double b1 = book1.getWholesale();
                Double b2 = book2.getWholesale();
        ...
        output += ("Total Wholesale value of books: $" + wholesale);
    }
